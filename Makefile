...
desktop-push: Dockerfile.desktop
	docker buildx build --platform linux/arm64,linux/amd64 -t zhrkasm.azurecr.io/kasm/desktop:testing --push -f Dockerfile.desktop .
...
vscode-push: Dockerfile.vscode
	docker buildx build --platform linux/arm64,linux/amd64 -t zhrkasm.azurecr.io/kasm/vscode:testing --push -f Dockerfile.vscode .
